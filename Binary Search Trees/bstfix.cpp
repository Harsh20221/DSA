...
#include<stdio.h>
using namespace std;
//*VERY IMP NOTE REGARDING THIS CODE: This code is working in replit  and CLion but not working in VS code  in this machine , The mystery remains unknown. till now. and no fixes have been found
struct node {
    node*lchild;
    node*rchild;
    int data;
